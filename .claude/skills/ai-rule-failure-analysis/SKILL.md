...
4. Предложи минимальное изменение системы правил: уточнить формулировку,
   добавить триггер, проверочный шаг, отрицательный пример, критерий остановки
   или тестовый случай.
...
- `Исправление`: минимальное изменение, которое снижает риск повторения.
